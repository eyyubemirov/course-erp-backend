...
import com.backend_tutorial.course_erp.filters.AuthorizationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        return http
                .authorizeHttpRequests(request -> {
                    ...
                    // Test endpoints
                    request.requestMatchers("/api/v1/test").authenticated();
                    request.requestMatchers("/api/v1/test/no-auth").permitAll();
...
//          authException.getCause().getStackTrace();
